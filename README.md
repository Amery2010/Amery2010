...
<img src="https://komarev.com/ghpvc/?username=Amery2010&style=flat-square&color=58A6FF&label=PROFILE+VIEWS" alt="Profile views" />
...
const amery = {
  ...
  currentWork: "Building AI-powered tools that bridge humans and machines",
  totalStars: "7,400+",
  openSourceOrgs: ["@u14app"],
  funFact:
    "I believe the best code is the one that writes itself — so I build AI to do exactly that.",
};
```
